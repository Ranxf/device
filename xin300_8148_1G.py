...
class xin300_8148:
    ...
    def config_uboot_env(self,ip):
        ...
        self.spawn_id.expect(self.uboot_prompt)
        self.spawn_id.sendline("setenv bootargs \'console=ttyO0,115200n8 noinitrd mem=384M rootwait=1 rw ubi.mtd=5,2048 rootfstype=ubifs root=ubi0:rootfs init=/init notifyk.vpssm3_sva=0xAFD00000 earlyprintk ddr_mem=1024M vram=20M\';")
        self.spawn_id.expect(self.uboot_prompt)
